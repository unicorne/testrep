...
public class Tools {
	...
	/**
	 * by Cornelius
     * calculates two points of equal hyperbolic distance to point
	 * 
	 * @param point
	 * @param point2
	 * @param distance
	 * @return two points of equal hyperbolic distance perpendicular to direction of second point
	 */
	...
	/**
	 * * by Cornelius
     * calculates circle coordinates as an n sided polygon to a given center point on hyperboloid with a given orientation
	 * 
	 * @param point
	 * @param orientation
	 * @param radius
	...
	/**
	 * interpolates spherical points with recursive midpoint method
	 *
	 * @param a
	 * @param b
	 * @return 3D point
